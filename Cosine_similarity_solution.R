...
require(Matrix)
weightm <- c(1.972, 1.25, 1.22, 1.00, 8.40, 0.625, 0.4) # males weights
weightf <- c(1.75, 0.75, 1.42, 1.00, 8.75, 0.625, 0.25) # female weights
...
write.csv(submission, file="mod_last_day_r_4.csv", row.names=FALSE)
